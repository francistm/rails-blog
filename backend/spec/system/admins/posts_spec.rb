...
describe 'Post form', type: :system do
  ...
  it 'submit with upload file' do
    ...
    post_attach_files = [].tap do |array|
      array << File.expand_path('../../fixtures/files/file-image-fixture-1.jpg', __dir__)
      array << File.expand_path('../../fixtures/files/file-image-fixture-2.jpg', __dir__)
      array << File.expand_path('../../fixtures/files/file-image-fixture-3.jpg', __dir__)
    end
